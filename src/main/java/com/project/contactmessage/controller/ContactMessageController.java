...
public class ContactMessageController {
    ...
    @GetMapping("/searchBetweenDates") //http://localhost:8080/contactMessages/searchBetweenDates?beginDate=2023-02-20&endDate=2023-02-25 + GET
